...
const CheckoutDetail = async ({ reservatonId }: { reservatonId: string }) => {
  const reservation = await getReservationById(reservatonId);
    ...
    <div className="grid md:grid-cols-2 gap-5">
      <div className="order-2">
        <div className="flex flex-col mb-3 items-start bg-white border border-gray-200 rounded-sm md:flex-row md:w-full">
          ...
          <div className="felx flex-col justify-between p-4 leading-normal w-full">
            <h5 className="mb-1 text-4xl font-bold tracking-tight text-gray-900">
              {reservation.Room.name}
            </h5>
            <div className="felx items-center gap-1 text-2xl text-gray-700">
