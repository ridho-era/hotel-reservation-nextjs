...
const Footer = () => {
  return (
    <footer className="bg-gray-900">
        <div className="mx-w-screen-xl mx-auto px-4 w-full py-10 md:py-16">
            <div className="grid md:grid-cols-3 gap-7">
                <div>
                    ...
                    <p className="text-gray-400">
                        ...
                        Doloribus, quod commodi voluptatem ad labore harum.
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <form action="" className="mt-5">
                            <div className="mb-5">
                                <input type="text" name="email" className="w-full p-3 rounded-sm bg-white" placeholder="milus@gmail.com" />
                            </div>
        ...
        <div className="mx-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base 
        text-gray-500">
            &copy; Copyright 2025 | miluss. |All Right Reserved
        </div>
    </footer>
  )
}
