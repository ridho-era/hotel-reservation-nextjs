  ...
  return (
    <div>
      {reservation.map((item) => (
        <div
          className="bg-white shadow pb-4 mb-4 md:pd-0 relative"
          key={item.id}
        >
          ...
          <div className="flex flex-col mb-4 items-start bg-white rounded-sm md:flex-row md:w-full">
            <Image
              ...
              alt="image room"
            />
            <div className="flex items-center gap-1 mb-3 px-4 font-normal text-gray-700 w-full">
          ...
          <div className="flex items-end justify-end absolute inset-4">
            {item.Payment?.status === "unpaid" ? (
              <Link
                ...
                className="px-6 py1 bg-orange-400 text-white rounded-md hover:bg-orange-500"
              >
                Pay Now
              </Link>
            ) : (
              <Link
                ...
                className="px-5 py1 bg-orange-400 text-white rounded-md hover:bg-orange-500"
              >
                View Detail
              </Link>
            )}
